...
from dataset.Dataset import Cifar10_MobileNet
import os
if USE_WANDB:
    import wandb
import random
...
config = {
    ...
    "device": "cuda:5",
    # dataset setting
    "dataset": Cifar10_MobileNet,
    "dim_per_token": 1024,
    "sequence_length": 2218,
    "max_input_length": 2218,
    # train setting
    "batch_size": 4,
    "num_workers": 4,
    "total_steps": 80000,
    ...
    "generated_path": Cifar10_MobileNet.generated_path,
    "test_command": Cifar10_MobileNet.test_command,
    # to log
...
if USE_WANDB:
    ...
    wandb.init(project="cifar10_MLP_final" if FINAL_RUNNING else "cifar10_MLP", config=config, name="2m_lstm_diffusion")
