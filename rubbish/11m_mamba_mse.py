...
from model.mamba import MambaModel as Model
from model.diffusion import DDIMSampler
from dataset.BaseDataset import Cifar10_ResNet18
if USE_WANDB:
    import wandb
import random
import warnings
...
def train():
    ...
    for batch_idx, param in enumerate(train_loader):
        ...
        prediction = F.adaptive_avg_pool1d(prediction, config["dim_per_token"])
